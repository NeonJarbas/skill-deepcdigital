...
class DeepCDigitalSkill(OVOSCommonPlaybackSkill):
    ...
    def initialize(self):
        url = "https://www.youtube.com/channel/UC-b1LXc71wj0rMVQOWw-UfQ"
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "deepcdigital"):
